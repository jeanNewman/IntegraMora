...
namespace WpfApplication1
{
    ...
    public class Integracion
    {
       ...
       // private MostrarError IError = null;
        ...
        ObservableCollection<MBancos> bancos = new ObservableCollection<MBancos>();
                             ...
                             string iniFinFactura, string sucursal, string conx, string mov, string vou)
        {
            ...
            try
            {
                ...
                foreach (var data in ComprasTotal)
                {
                    ...
                    this.Cos_cCodigo = (data.cuenta == "40111" || data.cuenta == "42120") ? "" : data.cCosto;
         ...
         //   cobroTotal.Clear();
            ...
            try
            {
                ...
                foreach (var data in cobroTotal)
                {
                    ...
                    if(data.cuenta == "16289")
                    {
                        this.Asd_cTipoDoc = "24";
                        this.Asd_cSerieDoc = "S"+ sTienda.Substring(1);
                    }
                    if (data.cuenta == "16299")
                    {
                        this.Asd_cTipoDoc = "24";
                        this.Asd_cSerieDoc = "R" + sTienda.Substring(1);
                    }
                    this.Pla_cCuentaContable = data.cuenta;
                   ...
                   // this.Asd_nDebeSoles = data.cuenta == "10112" ? 0 :data.debe;
                    ...
                    this.Asd_cNumDoc = data.cuenta == "10111" ? cadena2.ToString()
                                     ...
                                     : data.cuenta == "16289" ? cadena2.ToString()
                                 ...
                                 string anulfecha, string anulserie, string anulnumero, string contClient, string contRuc, string direccion)
        {
            ...
            try
            {
                ...
                foreach (var data in  ventaTotal)
                {
                    ...
                    this.Cos_cCodigo = data.cuenta == "70111" ? data.serie : "";
                    this.Ten_cTipoEntidad = (data.cuenta == "12121" || data.cuenta == "46997")  ? "C" : "";
                  
                    this.Ent_cCodEntidad = data.cuenta == "12121" ? codigoDeEntidad(contClient,contRuc,direccion,conx): data.cuenta == "46997"?"06449": "";
        ...
        private void SincronizarBanco(string sAnio, string sPeriodo, string sLibro, string sGlosa, string sFechaSql, string conx, string mov, string vou, string moneda)
        {
            //consulta que saca la informacion de ventas
            ...
            try
            {
                ...
                this.Asd_dFecDoc = sFechaSql;
                    ...
                    this.Asd_cSerieDoc = "0000";
               

                this.Imp_nPorcentaje = 18;
                this.Asd_cOperaTC = moneda == "DOLARES" ? "VEP" : "SCV";
                this.Asd_cTipoMoneda = moneda == "DOLARES" ? "040" : "038";
                this.Asd_cEstado = "A";
                this.Asd_cUserCrea = "DPEREZ";
                this.Asd_cUserModifica = "DPEREZ";
                this.Asd_cEquipoUser = "CONTABILIDAD";
                this.Asd_cTipoDocRef =  "";
                this.Asd_cSerieDocRef = "";
                this.Asd_dFecDocRef =  "NULL";
                this.Asd_cNumDocRef = "";
             
                int i = 0;
                foreach (var data in bancos)
                {
                    this.Pla_cCuentaContable = data.Cuenta;
                    this.Asd_nItem = i + 1;
                    this.Asd_nDebeSoles = moneda == "DOLARES" ? 0: data.VentaDebe;
                    this.Asd_nHaberSoles = moneda == "DOLARES" ? 0 : data.VentaHaber;
                    this.Asd_nDebeMonExt = moneda == "DOLARES" ? data.VentaDebe : 0;
                    this.Asd_nHaberMonExt = moneda == "DOLARES" ? data.VentaHaber : 0;
                    this.Asd_cTipoDoc = data.Tipo == "D"?"21":"24";
                    this.Cos_cCodigo =  "";
                    this.Ten_cTipoEntidad =  "";

                    this.Ent_cCodEntidad = "";
                    this.Asd_cNumDoc = data.Operacion;
                    this.Asd_cBaseImp =  "";
                    string query2 = @"spCn_GrabaAsientoDet 'INSERTAR','" + this.Ase_cNummov + "','" + this.Emp_cCodigo + "','" + this.Pan_cAnio + "','" + this.Per_cPeriodo + "','" +
                                           this.Lib_cTipoLibro + "','" + this.Ase_nVoucher + "'," + this.Asd_nItem + ",'" + this.Pla_cCuentaContable + "','" + sGlosa + "'," +
                                           this.Asd_nDebeSoles + "," + this.Asd_nDebeMonExt + "," + this.Asd_nHaberSoles + "," + this.Asd_nHaberMonExt + "," + this.Asd_nTipoCambio + ",'" +
        ...
        public void verficarCobros(string fechaSql, string conex1, string conex2)
        {
          ...
          //  decimal sumFacturaDol = 0;
            ...
            string[] consulta= { "sc.VENTAS_MIRAFLORES = 'T'", "sc.VENTAS_SURCO = 'T' ", "sc.VENTAS_SAN_ISIDRO = 'T'","sc.VENTAS_BORJAS = 'T'","sc.VENTAS_GALVEZ = 'T'" };
            string[] tiendas = {"MIRAFLORES","SURCO","SAN ISIDRO","DARK AVIACION","GALVEZ"};
            string t = "";
            string serie = "";
            string sql = "";
            string sqlT = "";
            ...
            foreach (string item in consulta)
             {
                i++;
                 ...
                 sqlT = @"SELECT S.SERIE FROM SERIES S INNER JOIN SERIESCAMPOSLIBRES SC ON S.SERIE = SC.SERIE WHERE " + item;
                 ...
                 sqlT = @"SELECT a.numero,CASE  WHEN d.total IS NULL THEN 0 ELSE d.total END AS total,a.IMPORTE,a.CODFORMAPAGO,c.DESCRIPCION
                                    ...
                                    WHERE " +item +"  and FECHADOCUMENTO = '" + fechaSql + "' order by numero";
                    ...
                    if (lector.HasRows)
                        {
                            ...
                            while (lector.Read())
                            {
                                ...
                                switch (x)
                                {
                                    ...
                                    case 2://visa
                                        ...
                                        break;
                                    case 3://master
                                        cobro.Add(new mCobros("16291", t, (lector.GetInt32(0)).ToString(), Convert.ToDecimal(lector.GetValue(2)), 0, "IZI PAY"));
                                        break;
                                    case 5://american
                                    ...
                                    case 12://casaazul
                                        ...
                                        break;
                                    case 17://lanve
                                        cobro.Add(new mCobros("16289", t, (lector.GetInt32(0)).ToString(), Convert.ToDecimal(lector.GetValue(2)), 0, "SOPITAS"));
                                        break;
                            ...
                            sumLanve = Math.Round(cobro.Sum(z => z.cuenta == "16289" ? z.debe : 0), 2);
                            ...
                            moneda = 0;
                                ...
                                while (moneda <= 1)
                                {
                                    ...
                                    if (moneda == 1)
                                    {
                                        ...
                                        if (sumMaster != 0)
                                            cobroTotal.Add(new mCobros("16291", sucursal, facturas, sumMaster, 0, "Izzi Pay"));
                                        if (sumVisa != 0)
                                        ...
                                        if (sumLanve != 0)
                                            cobroTotal.Add(new mCobros("16289", sucursal, facturas, sumLanve, 0, "Lanve"));
                                        if (sumInterbank != 0)
        ...
        public void verficarVentas(string fechaSql,string conex1,string conex2)
        {
            ...
            string[,] tiendas =  { {"Miraflores","B001"}, {"Miraflores","F001"}, {"Miraflores","BC01"}, {"Miraflores","FC01"},
                                   ...
                                   {"Dark Aviacion","B009"}, {"Dark Aviacion","F009"}, {"Dark Aviacion","BC09"}, {"Dark Aviacion","FC09"},
                                   {"Galvez","B008"}, {"Galvez","F008"}, {"Galvez","BC08"}, {"Galvez","FC08"},
                                   {"Galvez","B011"}, {"Galvez","F011"}, {"Galvez","BC11"}, {"Galvez","FC11"},
                                   {"Galvez","B012"}, {"Galvez","F012"}, {"Galvez","BC12"}, {"Galvez","FC12"},};
            string t = "";
            string sql = "";
            string sucursal = "";
            string facturas = "";
           ...
           for (int j = 1; j < 41; j++)
             {
                ...
                t = tiendas[j - 1, 0] == "Miraflores" ? "01" : tiendas[j - 1, 0] == "Surco" ? "02" : tiendas[j - 1, 0] == "San Isidro" ? "05" : tiendas[j - 1, 0] == "Galvez" ? "08" :"07";
                serieAnul = "";
                nuemroAnul = "";
                fechaAnul = "";
                ...
                try
                {
                    ...
                    if (reader.HasRows)
                    {
                        if (cadena != "B0" && cadena != "00") //CONDICIONA LAS FACTURAS 
                        {
                            
                            while (reader.Read())
                            {
                                venta.Clear(); //AÑADIMOS VALORES AL MODELO DE VENTAS DEPENDIENDO A SU CUENTA CONTABLE
                                ...
                                // AQUI CALCULAMOS AQUIEN LE PERTENECE CADA NOTA DE CREDITO
                       ...
                       // no hay error en el asiento es decir no hay diferencia en la cxc y el total neto
                        ...
                        if (cadena == "B0" || cadena == "00") //CONDICION PARA BOLETAS AGRUPA TODAS LAS BOLETAS PARA EMITIR UN SOLO COMPROBANTE
                        {
                            venta.Clear();
        ...
        public void verificarCompras(string fechaSql,string secuencia,string cc, string conex1, string conex2)
        {
            ...
            DateTime emision;
             if (myProperty == "0"){
                 movimiento2 = "' and (a.NUMSERIE != '4C' and a.NUMSERIE != 'A') " + "and sc.centro_costo = '" +cc+"' ";
            ...
            try
            {
                ...
                //consulta que saca la informacion de ventas
                    ...
                    sql = @"select a.NUMALBARAN,
                            ...
                            case when len(a.SUALBARAN) > 8 then 'err' else replicate ('0',(8 - len( coalesce(a.sualbaran,'0')))) + convert(varchar, coalesce(a.sualbaran,'0')) end as SUALBARAN,
                            ...
                            sc.centro_costo as cCosto,
                            s.descripcion as descripCosto
	                         ...
	                         left join SERIES as s on a.numserie = s.SERIE
							 left join SERIESCAMPOSLIBRES as sc on s.SERIE = sc.SERIE
                        where a.FECHAALBARAN = '" + fechaSql + movimiento2 + " and pro.NIF20 != '20491980860' and  upper(ac.TIPO_DOCUMENTOP) = 'F'  " +
                        "group by a.NUMALBARAN, p.ENTIDAD, ac.serie_doc, pro.NIF20, pro.NOMPROVEEDOR,a.SUALBARAN,A.FECHAALBARAN,ac.fecha_emision,s.descripcion, sc.centro_costo,s.descripcion ";
                    ...
                    if (reader.HasRows)
                    {
                        while (reader.Read())
                        {
                            ...
                            ComprasTotal.Add(new mCompras("42120", reader.GetString(1), reader.GetValue(5).ToString(), 0, Convert.ToDecimal(reader.GetValue(8)), reader.GetString(2), reader.GetString(10)));
                                ...
                                centroCosto = reader.GetString(11);
                            vg.Libro = "06";
                            vg.Glosa = reader.GetString(11) +"_"+ secuencia + " Nro. " + reader.GetString(5) + " Proveedor: " + reader.GetString(1) + " " + reader.GetString(3) + " " + reader.GetString(4);
        ...
        public void VerficarBancos(System.Windows.Controls.DataGrid dgv, string conex1, string conex2,DataTable dt,string tienda,string moneda)
        {
           ...
           // string valor = "";
            ...
            var listDepositos = new ObservableCollection<ListDepositos>();
         
                try
            {
                foreach (DataRow row in dt.Rows)
                {
                    listDepositos.Add(new ListDepositos
                    {
                        Banco = row["banco"].ToString().Trim(),
                        Tipo = row["tipo"].ToString().Trim(),
                        Venta = Convert.ToDecimal(row["venta"]),
                        Operacion = row["operacion"].ToString().Trim(),
                        Fecha = DateTime.ParseExact(row["fecha"].ToString(),"dd/MM/yyyy", CultureInfo.InvariantCulture)

                    });

                }

                foreach (var depo in listDepositos)
                {


                    fechaDepo = depo.Fecha.ToString("dd/MM/yyyy");
                    fecha = Convert.ToDateTime(fechaDepo);
                    break;

                }

                // fechaAnul = dgv.Columns[0].GetCellContent(row);

                foreach (var item in listDepositos)
                {

                    if (item.Banco == "BS" || item.Banco == "IS" || item.Banco == "ID" || item.Banco == "BBS" || item.Banco == "BBD")
                    {



                        if (item.Fecha.ToString("dd/MM/yyyy") != fechaDepo)
                        {


                           
                                int mon = moneda == "DOLARES" ? 2 : 1;
                                crearCabecera(vg.Anio, vg.Periodo, vg.Libro, vg.Glosa, conex2, fechaDepo, ref movi, ref vouc, mon);
                                SincronizarBanco(vg.Anio, vg.Periodo, vg.Libro, vg.Glosa, fechaDepo, conex2, movi, vouc, moneda);
                                bancos.Clear();
                            

                        }
                        vg.Anio = item.Fecha.Year.ToString();
                        vg.Periodo = item.Fecha.ToString("MM");
                        vg.Libro = "02";
                        vg.Glosa = "INTEGRACION-Deposito Efectivo: " + fechaDepo + " " + tienda + " " + listDepositos.IndexOf(item);

                        fechaDepo = item.Fecha.ToString("dd/MM/yyyy");
                        {
                            valorBanco = item.Banco;
                            switch (valorBanco)
                            {
                                case "BS":
                                    cuenta = "10417";
                            ...
                            for (int i = 0; i < 2; i++)
                            {
                                valorDebe = item.Venta;
                                valorHaber = 0;
                                operaciones = item.Operacion;
                                tipo = item.Tipo;

                                if (i == 1)
                                {
                                    valorHaber = item.Venta;
                                    valorDebe = 0;
                                    cuenta = moneda == "DOLARES"?"10112": "10111";
                                    tipo = item.Tipo;
                                }


                                bancos.Add(new MBancos(cuenta, operaciones, tipo, valorDebe, valorHaber));
                            }

                        }
                        if (listDepositos.IndexOf(item) == listDepositos.Count - 1)
                        {
                            vg.Glosa = "Deposito Efectivo: " + fechaDepo + " " + tienda +" "+ listDepositos.IndexOf(item);
                            int mon = moneda == "DOLARES" ? 2 : 1;
                            crearCabecera(vg.Anio, vg.Periodo, vg.Libro, vg.Glosa, conex2, fechaDepo, ref movi, ref vouc, mon);
                            SincronizarBanco(vg.Anio, vg.Periodo, vg.Libro, vg.Glosa, fechaDepo, conex2, movi, vouc, moneda);
                            bancos.Clear();
